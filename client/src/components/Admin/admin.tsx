                                    ...
                                    <section className="layer" data-show="1">
                                        <div className="ui-card -notification">
                                            ...
                                            <div className="ui-content">
                                                <div className="ui-title">Shaw Phill</div>
                                                <div className="ui-message">Requested: Three Canned Fruits</div>
                                            </div>
                                        ...
                                        <div className="ui-card -notification">
                                            <img src="http://i.pravatar.cc/100?u=7" alt="avatar" />
                                            <div className="ui-content">
                                                <div className="ui-title">Rose Smith</div>
                                                <div className="ui-message">Requested: Two bags of rice</div>
                                            </div>
                                            <button className="acceptbutton" type="button">
                                                Accept
                                            </button>
                                        ...
                                        <div className="ui-card -notification">
                                            <img src="http://i.pravatar.cc/100?u=77" alt="avatar" />
                                            <div className="ui-content">
                                                <div className="ui-title">Mindy Reyes</div>
                                                <div className="ui-message">Requested: Toiletries</div>
                                            </div>
                                            <button className="acceptbutton" type="button">
                                                Accept
                                            </button>
                                        ...
                                        <div className="ui-card -notification">
                                            <img src="http://i.pravatar.cc/100?u=61" alt="avatar" />
                                            <div className="ui-content">
                                                <div className="ui-title">Mark Lee</div>
                                                <div className="ui-message">Requested: Five Canned Beans</div>
                                            </div>
                                            <button className="acceptbutton" type="button">
                                                Accept
                                            </button>
                                ...
                                <div className="app-wrapper">
                                    <section className="layer" data-show="1">
                                        <div className="ui-card -notification">
                                            ...
                                            <div className="ui-content">
                                                <div className="ui-title">Laura Coste</div>
                                                <div className="ui-message">Donated: $50</div>
                                            </div>
                                        ...
                                        <div className="ui-card -notification">
                                            <img src="http://i.pravatar.cc/100?u=13" alt="avatar" />
                                            <div className="ui-content">
                                                <div className="ui-title">John Doe</div>
                                                <div className="ui-message">Donated: $150</div>
                                            </div>
                                            <button className="thankyoubutton" type="button">
                                                Thank You
                                            </button>
                                        ...
                                        <div className="ui-card -notification">
                                            <img src="http://i.pravatar.cc/100?u=64" alt="avatar" />
                                            <div className="ui-content">
                                                <div className="ui-title">Francisco at CISCO Company</div>
                                                <div className="ui-message">Donated $1000</div>
                                            </div>
                                            <button className="thankyoubutton" type="button">
                                                Thank You
                                            </button>
                                        ...
                                        <div className="ui-card -notification">
                                            <img src="http://i.pravatar.cc/100?u=57" alt="avatar" />
                                            <div className="ui-content">
                                                <div className="ui-title">David Piano</div>
                                                <div className="ui-message">Donated: $500</div>
                                            </div>
                                            <button className="thankyoubutton" type="button">
                                                Thank You
                                            </button>
