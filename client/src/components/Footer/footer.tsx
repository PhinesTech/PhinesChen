...
const Footer: React.FC = () => {
    return (
        <footer className="footer bg-yellow-600">
            <section className="Footer-container">
                <nav className="Footer-social">
                    <a href="mailto:info@mmcfb.org?" style={{ color: '#0000' }}>
                    ...
                    <a href="tel:(209)726-3663" target="_blank" rel="noopener noreferrer" style={{ color: '#0000' }}>
                        <FontAwesomeIcon icon={faPhone} className="fa" />
                    </a>
                </nav>
            </section>
            <section className="credits">
                <p className="copyright">© 2020 Merced County Food Bank</p>
            </section>
        </footer>
    );
};
